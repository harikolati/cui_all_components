 ...
 */
export declare class CuiIconRegistry {
    private _httpClient;
    private _sanitizer;
    /**
...
export declare function ICON_REGISTRY_PROVIDER_FACTORY(parentRegistry: CuiIconRegistry, httpClient: HttpClient, sanitizer: DomSanitizer): CuiIconRegistry;
export declare const ICON_REGISTRY_PROVIDER: {
    provide: typeof CuiIconRegistry;
    deps: (Optional[] | typeof DomSanitizer)[];
    useFactory: (parentRegistry: CuiIconRegistry, httpClient: HttpClient, sanitizer: DomSanitizer) => CuiIconRegistry;
};
