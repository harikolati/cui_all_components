...
Mobile = (function () {
     ...
     */
    function () {
        var /** @type {?} */ mobileWindow = window;
        var /** @type {?} */ userAgent = mobileWindow.navigator.userAgent ||
            mobileWindow.navigator.vendor ||
            mobileWindow['opera'];
...
function MobileWindow_tsickle_Closure_declarations() {
